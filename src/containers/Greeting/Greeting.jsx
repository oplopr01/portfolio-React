            ...
            <div className="max-width homeContainer">
                <div className="home-content">
                    ...
                    <div className="resume">
                        <a href={process.env.PUBLIC_URL + `LakhanRathore_FullStack_0.pdf`} target="_blank">See My Resume</a>
                    </div>  
                    <div className="profileLinks">
                        <a href="https://www.linkedin.com/in/lakhan-rathore-b88796188" target="_blank">LinkedIn</a>
